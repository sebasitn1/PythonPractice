...
def segment(pt1, pt2):
    return [x+y for (x,y) in zip(v,w) for a in range(101) for b in range(101) for x in  scalar_vector_mult(a/100, pt1) for y in scalar_vector_mult(b/100, pt2 ) if a + b == 100]
